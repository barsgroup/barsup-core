...
from pynch.util import load_configs as _load_configs
from pynch import validators as _validators
...
class Frontend:
    ...
    def __init__(self, *, spec, container, api, router, initware,
        ...
        :type api: API
        :param router: Router
        :type router: pynch.router.Router
...
def get_defaults():
    ...
    return {
        ...
        'frontend': {
            'default': {
                '__realization__': 'pynch.core.Frontend',
                '__type__': 'singleton',
        ...
        'api': {
            'default': {
                '__realization__': 'pynch.core.API',
                '__type__': 'singleton',
                'container:__internal__': '__this__',
                'middleware': []
            },
        ...
        'router': {
            'default': {
                '__realization__': 'pynch.router.Router',
                '__type__': 'singleton'
            }
        },
        'module': {
            '__default__': {
                '__realization__': 'pynch.core.init',
                '__type__': 'singleton',
